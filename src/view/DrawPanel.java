...
public class DrawPanel extends JPanel
{
		...
		TimerTask colorChange = new TimerTask()
		{
			...
			public void run()
			{
				if (currentNumb < colorNumb)
				{
					...
					// deltaGreen = (next.getGreen() -
					// current.getGreen())/colorNumb;
					// deltaBlue = (next.getBlue() -
					// current.getBlue())/colorNumb;
	...
	private void setupLayout()
	{
		...
		layout.putConstraint(SpringLayout.WEST, rectButton, 0, SpringLayout.WEST, triButton);
		layout.putConstraint(SpringLayout.SOUTH, rectButton, -6, SpringLayout.NORTH, triButton);
		layout.putConstraint(SpringLayout.NORTH, earse, 8, SpringLayout.SOUTH, polyButton);
		layout.putConstraint(SpringLayout.WEST, earse, 0, SpringLayout.WEST, triButton);

		layout.putConstraint(SpringLayout.NORTH, save, 10, SpringLayout.SOUTH, earse);
		layout.putConstraint(SpringLayout.WEST, save, 0, SpringLayout.WEST, rectButton);
	}
